...
```{r CREATE TABLE-Anweisung für den Index umbauen, eval=FALSE}
...
for (i in 1:nrow(create_relation)){
 ...
 dbExecute(db01, paste0("update '", relation[1,3], 
                        "' set '", relation[1,2], 
                        "' = '", relation[1,4], "';")) 
} 
```
